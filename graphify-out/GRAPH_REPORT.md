...
## Corpus Check
- 133 files · ~169,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 800 nodes · 1801 edges · 83 communities detected
- Extraction: 48% EXTRACTED · 52% INFERRED · 0% AMBIGUOUS · INFERRED: 930 edges (avg confidence: 0.64)
...
Cohesion: 0.04
Nodes (72): BaseIndicator, All indicators extend this.     Subclasses implement compute() using vectorized, BaseIndicator, Replay Engine — sync DB version., ReplayEngine, ReplaySession, ReplayState, Exception (+64 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (48): _calculate_metrics(), list_saved_results(), check_db_rows(), check(), check_jobs(), check_pfc(), check_pfc_history(), check() (+40 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (43): data_requirements(), IndicatorRequirement, StrategyContext, StrategyDataRequirements, StrategySignal, BaseStrategy, IndicatorCalculator, Enum (+35 more)
...
- **Thin community `Community 78`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `read_exception.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `read_scanner_log.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `read_task_log.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `get_sync_session()` connect `Community 1` to `Community 2`, `Community 11`, `Community 4`, `Community 5`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `OHLCVRepository` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 8`, `Community 12`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Stock` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`?**
